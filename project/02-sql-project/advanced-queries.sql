...
8. 三班的学生名单   
SELECT * FROM students WHERE class = 'Class 3';   

9. 张老师教的课程   
SELECT * FROM courses WHERE teacher = 'Mr. Zhang';   
...
sc.score   
FROM students s   
JOIN scores sc ON s.student_id = s.student_id   
